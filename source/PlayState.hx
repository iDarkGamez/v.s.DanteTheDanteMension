...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Even worse than iDarkGames SMH', 0.2], //From 0% to 19%
		['Nah bro you gon' die', 0.4], //From 20% to 39%
		['Uh.', 0.5], //From 40% to 49%
		['You Good?', 0.6], //From 50% to 59%
		['Cringe', 0.69], //From 60% to 68%
		['HAHAHAH FUNNY NUMBER!!!!!!', 0.7], //69%
		['Getting a little better', 0.8], //From 70% to 79%
		['Rat_Lord would be Jealous', 0.9], //From 80% to 89%
		['Dante's Appentice?', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "botplay moment", 32);
	...
	{
		scoreTxt.text = 'Dante moments: ' + songScore
		+ ' | iDarkGames moments: ' + songMisses
		+ ' | Judgement: ' + ratingName
		+ (ratingName != 'BOTPLAY YOOOOO' ? ' (${Highscore.floorDecimal(ratingPercent * 100, 2)}%) - $ratingFC' : '');
